  ...
  <body class="app sidebar-mini rtl">
   ...
   <?php include 'include/header.php'; ?>
    ...
    <?php include 'include/sidebar.php'; ?>
      <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()">TThe KYAU GYM Management System is a digital platform developed to efficiently manage the gym facilities of Khwaja Yunus Ali University (KYAU). This system streamlines the operations of the university's gym by automating key tasks such as.</marquee>
