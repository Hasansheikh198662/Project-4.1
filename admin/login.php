...
<html>
  <head>
    ...
    <title>KYAU GYM MS | Admin login</title>
    <link rel="icon" type="image/x-icon" href="https://img.icons8.com/?size=100&id=aaamNJ9jOdo4&format=png&color=000000">
  </head>
  <body>
      <marquee onMouseOver="this.stop()" style="color:rgb(255, 255, 255);" onMouseOut="this.start()">The KYAU GYM Management System is a digital platform developed to efficiently manage the gym facilities of Khwaja Yunus Ali University (KYAU). This system streamlines the operations of the university's gym by automating key tasks such as.</marquee>
